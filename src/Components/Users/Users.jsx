  ...
  return (
    <>
      <div className="container users text-center w-50   mt-5  rounded-3">
        ...
        <h3 className="bg-warning"> Note::If you would like to see a graph of the total transaction amount per day for the selected
customer.<br/>click on the customer's name</h3>
        <div className="row ">
